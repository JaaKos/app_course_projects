...
import { StyleSheet, Text, View, Button, Alert, Image, Linking, ToastAndroid } from 'react-native';
...
function FirstScreen() {
  ...
  return (
    ...
    <Dialog.Container visible={dialogVisible}>
      ...
      <View style={[styles.elementRow, styles.intents]}>
        <Button onPress={() => Linking.openURL("https://google.com")} title='Google'></Button>
        <Button onPress={() => Linking.openURL("mailto:support@example.com")} title='Contact support'></Button>
      </View>
